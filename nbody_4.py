"""
    ...
    Here I keep the changes made in nbody_3.py because it also works to 
    aggregate loops in the functions.  However, I make another change to 
    the report_energy function, taking out the nested loop that iterated through
    all keys in BODIES.
    
    Achieve relative speedup of only about 1.0153 here.
"""
