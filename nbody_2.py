"""
    ...
    Here I replace the seenit data structure from a list to a dict to 
    facilitate membership testing.
    
    We get a relative speedup of only 1.00893 here.
"""
...
def advance(dt):
    ...
    for body1 in BODIES.keys():
        for body2 in BODIES.keys():
            if (body1 != body2) and not (body2 in seenit.keys()):
