"""
    ...
    Here I use local variables instead of global variables, particularly
    the BODIES dict and PI, SOLAR_MASS, and DAYS_PER_YEAR. In order to do
    this, I have to combine the report_energy, advance, and offset_momentum functions
    into one --> report_energy.
    
    Achieve relative speedup of only about 1.1034.
"""
...
def report_energy(loops, reference, iterations, dt = 0.01):
    '''
        Loops through the BODIES dict (loops * iterations) times, reporting the
        energy every iteration (20000 times). Combines the offset_momentum, advance and 
        nbody functions.
    '''
